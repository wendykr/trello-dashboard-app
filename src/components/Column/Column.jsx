...
export const Column = ({ title, columns, id, rows, setRows, labels, labelsDatabase, comments, onClickCopy, onClickDetail, isShowDetailItem, onUpdateTitle, onUpdateDone }) => {
